...
#include "../../report_card/result_window.h"
...
QT_MOC_LITERAL(1, 14, 17), // "result_window_out"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "Result_window\0result_window_out\0"
};
...
void Result_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->result_window_out(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Result_window::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Result_window::result_window_out)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Result_window::result_window_out()
{
