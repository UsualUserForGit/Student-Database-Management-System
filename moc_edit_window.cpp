...
QT_MOC_LITERAL(3, 22, 15), // "edit_window_out"
QT_MOC_LITERAL(4, 38, 18), // "add_stud_ok_window"
QT_MOC_LITERAL(5, 57, 20), // "add_stud_canc_window"
QT_MOC_LITERAL(6, 78, 18), // "table_cell_changed"
QT_MOC_LITERAL(7, 97, 25) // "saved_chng_button_pressed"

    },
    "Edit_window\0notEmpty\0\0edit_window_out\0"
    "add_stud_ok_window\0add_stud_canc_window\0"
    "table_cell_changed\0saved_chng_button_pressed"
};
...
void Edit_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->edit_window_out(); break;
        case 2: _t->add_stud_ok_window(); break;
        case 3: _t->add_stud_canc_window(); break;
        case 4: _t->table_cell_changed(); break;
        case 5: _t->saved_chng_button_pressed(); break;
        default: ;
        }
        ...
        {
            typedef void (Edit_window::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Edit_window::edit_window_out)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Edit_window::edit_window_out()
{
